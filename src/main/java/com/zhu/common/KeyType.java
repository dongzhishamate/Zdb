...
public class KeyType {
  ...
  public static boolean isTypeEqualByNatualConversion(int type1, int type2) {
    return type1 == type2 || (isDigitalType(type1) && isDigitalType(type2)) ||
            (isStringTypeCube(type1) && isStringTypeCube(type2) || (isFloatType(type1) && isFloatType(type2)));
  }
}
